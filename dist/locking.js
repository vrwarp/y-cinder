...
import { doc, collection, getDoc, setDoc, deleteDoc, runTransaction, serverTimestamp, } from "@firebase/firestore";
...
export function releaseLock(config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const lockRef = doc(db, path, FIRESTORE_PATHS.LOCK_COMPACTION);
        try {
            yield runTransaction(db, (transaction) => __awaiter(this, void 0, void 0, function* () {
                const lockSnap = yield transaction.get(lockRef);
